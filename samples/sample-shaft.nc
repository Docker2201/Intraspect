...
;( A copy of the test fixture, for opening in the program. The checks will   )
;( say T1..T3 are not in the magazine: that is the first thing to try, the   )
;( fix it offers adds them.                                                  )
